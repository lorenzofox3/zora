...
export const equal = (actual, expected, description = 'should be equivalent') => ({
...
export const notEqual = (actual, expected, description = 'should not be equivalent') => ({
    pass: !eq(actual, expected),
    actual,
    expected,
    description,
...
export const isNot = (actual, expected, description = 'should not be the same') => ({
    pass: !Object.is(actual, expected),
    actual,
    expected,
    description,
